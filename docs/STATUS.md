...
>
> Last updated: **2026-04-21** (Phase 5c shipped — Chat realtime end-to-end. Core DECISIONS.md #2 moat live: users can Contact seller on property listings → conversation created → thread opens → messages arrive live via Supabase Realtime. Inbox + tabs + archive/block all wired. 42 local commits across Phases 3→5c.)
