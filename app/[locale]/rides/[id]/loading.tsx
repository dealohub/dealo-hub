 ...
 *
 * Same shape as the property detail skeleton — 2-column content
 * + sticky sidebar — tuned for the automotive key-info density
 * (6-row spec grid instead of the 8-row property grid).
 */
