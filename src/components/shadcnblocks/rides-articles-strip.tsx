          ...
          {ARTICLES.map((a, i) => (
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden">
                ...
                <span className="absolute start-3 top-3 inline-flex items-center gap-1 rounded-full bg-black/55 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-white backdrop-blur-md">
