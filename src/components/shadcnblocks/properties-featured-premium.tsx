...
export default function PropertiesFeaturedPremium({ featured, locale }: Props) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-border/40 bg-gradient-to-b from-foreground/[0.03] via-transparent to-transparent py-10 md:py-14">
